...
public class Payload {
    ...
    public static String createEmployeeJsonPayload(){
        ...
        obj.put("emp_firstname","abra");
        obj.put("emp_lastname","dabra");
    ...
    public static String updatePartialEmployeePayload() {
        JSONObject obj = new JSONObject();
        obj.put("employee_id", "98335A");
    ...
    public static String gettingAllEmployeespayload(){
        JSONObject obj = new JSONObject();
        obj.put("emp_firstname","abra");
        obj.put("emp_lastname","dabra");
        obj.put("emp_middle_name","ms");
    ...
    public static String gettingAllJobtitlespayload(){
        JSONObject obj = new JSONObject();
        obj.put("emp_firstname","abra");
        obj.put("emp_lastname","dabra");
        obj.put("emp_middle_name","ms");
